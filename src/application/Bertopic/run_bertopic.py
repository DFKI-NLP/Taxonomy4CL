"""Run bertopic on abstracts from arXiv papers taged as cs.CL"""
...
for label in labels:
    ...
    topic_model.get_document_info(docs).to_csv(
        f"../../../data/results/csv/doc_info_{label}s.csv", index=False
    )
    ...
    hierarchy_fig.write_html(f"../../../data/results/html/hierarchy_{label}s.html")

    hierarchy_fig.write_image(f"../../../data/results/pdf/hierarchy_{label}s.html")
